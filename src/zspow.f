...
C    SOLVER FOR NONLINEAR ALGEBARIC EQUATIONS
C
C
C                                                                       ZSPO0020
C-----------------------------------------------------------------------ZSPO0030
...
C-----------------------------------------------------------------------ZSPO0820
C                                                                       ZSPO0830
      SUBROUTINE ZSPOW (FCN,NSIG,N,ITMAX,PAR,X,FNORM,WK,IER)            ZSPO0840
C                                  SPECIFICATIONS FOR ARGUMENTS         ZSPO0850
      INTEGER            NSIG,N,ITMAX,IER                               ZSPO0860
      REAL               PAR(1),X(N),FNORM,WK(1)                        ZSPO0870
...
c	  enddo
    ...
    5 CONTINUE                                                          ZSPO1050
      ...
      CALL ZSPWA(FCN,N,X,WK(6*N+1),XTOL,MAXFEV,ML,MU,EPSFCN,WK(1),      ZSPO1090
