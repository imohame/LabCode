      subroutine strdsp (x11,x12,x13,x14,vlinc)
...
c
     ...
     3ph1(nelemg),ph2(nelemg),ph3(nelemg),ph4(nelemg)
      common/vect5/
     1 xj11(nelemg),xj12(nelemg),xj21(nelemg),xj22(nelemg),
     > vlinv(nelemg),
     2 xji11(nelemg),xji12(nelemg),xji21(nelemg),xji22(nelemg),
     > radius(nelemg),
     3 radinv(nelemg),x1111(nelemg),x1113(nelemg),x2222(nelemg),
     > x2221(nelemg),
     4 x1221(nelemg),x2111(nelemg),x1222(nelemg),x2113(nelemg)
      common/vect13/
     1 x1112(nelemg),x1314(nelemg),x1114(nelemg),x1213(nelemg),
     2 x2122(nelemg),x2324(nelemg),x2124(nelemg),x2223(nelemg)
!!!      common/kkk/km,kkjj
c
      dimension x11(*),x12(*),x13(*),x14(*),vlinc(*)
