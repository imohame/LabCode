...
C-----------------------------------------------------------------------ZSPS0260
C                                                                       ZSPS0270
      SUBROUTINE ZSPWB1(FCN1,N,X,FVEC,FJAC,LDFJAC,IFLAG,ML,MU,EPSFCN,WA1ZSPS0280
     *                  ,WA2,PAR)                                       ZSPS0290
...
C                                  JACOBIAN.                            ZSPS0460
      DO 10 J=1,N                                                       ZSPS0470
         ...
         X(J) = TEMP+H                                                  ZSPS0510
         CALL FCN1(X,WA1,N,PAR)                                          ZSPS0520
...
C                                  JACOBIAN.                            ZSPS0630
   ...
   25    CONTINUE                                                       ZSPS0700
         CALL FCN1(X,WA1,N,PAR)                                          ZSPS0710
