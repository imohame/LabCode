...
!###################################################################
!###################################################################
subroutine FractReadApplyPreCrackCleavagePlanes(x,y,ix)
...
!    use EC_ElemCrackingBaseClass
    ...
    read (60, *)    mEC_DecayCount !-- 20 * min elem diagonal
    write (6011, *) mEC_DecayCount !-- 20 * min elem diagonal
...
!!! if the fracture is not active then exit
    ...
    write(6011, *) '!!!--------- id  ed1     rxc1    ryc1     r1  ed2     rxc2    ryc2     r2'
