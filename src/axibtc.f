...
!$OMP PARALLEL DO       
      do 10 i=lft,llt
      cb11(i)=d(1,3,i)*ph1(i)+d(1,1,i)*py1(i)+d(1,4,i)*pz1(i)
      cb21(i)=d(2,3,i)*ph1(i)+d(2,1,i)*py1(i)+d(2,4,i)*pz1(i)
      cb31(i)=d(3,3,i)*ph1(i)+d(3,1,i)*py1(i)+d(3,4,i)*pz1(i)
      cb41(i)=d(4,3,i)*ph1(i)+d(4,1,i)*py1(i)+d(4,4,i)*pz1(i)
      cb12(i)=d(1,2,i)*pz1(i)+d(1,4,i)*py1(i)
      cb22(i)=d(2,2,i)*pz1(i)+d(2,4,i)*py1(i)
      cb32(i)=d(3,2,i)*pz1(i)+d(3,4,i)*py1(i)
      cb42(i)=d(4,2,i)*pz1(i)+d(4,4,i)*py1(i)
   10 continue
!$OMP PARALLEL DO       
      do 20 i=lft,llt
      cb13(i)=d(1,3,i)*ph2(i)+d(1,1,i)*py2(i)+d(1,4,i)*pz2(i)
      cb23(i)=d(2,3,i)*ph2(i)+d(2,1,i)*py2(i)+d(2,4,i)*pz2(i)
      cb33(i)=d(3,3,i)*ph2(i)+d(3,1,i)*py2(i)+d(3,4,i)*pz2(i)
      cb43(i)=d(4,3,i)*ph2(i)+d(4,1,i)*py2(i)+d(4,4,i)*pz2(i)
      cb14(i)=d(1,2,i)*pz2(i)+d(1,4,i)*py2(i)
      cb24(i)=d(2,2,i)*pz2(i)+d(2,4,i)*py2(i)
      cb34(i)=d(3,2,i)*pz2(i)+d(3,4,i)*py2(i)
      cb44(i)=d(4,2,i)*pz2(i)+d(4,4,i)*py2(i)
   20 continue
!$OMP PARALLEL DO       
      do 30 i=lft,llt
      cb15(i)=d(1,3,i)*ph3(i)+d(1,1,i)*py3(i)+d(1,4,i)*pz3(i)
      cb25(i)=d(2,3,i)*ph3(i)+d(2,1,i)*py3(i)+d(2,4,i)*pz3(i)
      cb35(i)=d(3,3,i)*ph3(i)+d(3,1,i)*py3(i)+d(3,4,i)*pz3(i)
      cb45(i)=d(4,3,i)*ph3(i)+d(4,1,i)*py3(i)+d(4,4,i)*pz3(i)
      cb16(i)=d(1,2,i)*pz3(i)+d(1,4,i)*py3(i)
      cb26(i)=d(2,2,i)*pz3(i)+d(2,4,i)*py3(i)
      cb36(i)=d(3,2,i)*pz3(i)+d(3,4,i)*py3(i)
      cb46(i)=d(4,2,i)*pz3(i)+d(4,4,i)*py3(i)
   30 continue
!$OMP PARALLEL DO       
      do 40 i=lft,llt
      cb17(i)=d(1,3,i)*ph4(i)+d(1,1,i)*py4(i)+d(1,4,i)*pz4(i)
      cb27(i)=d(2,3,i)*ph4(i)+d(2,1,i)*py4(i)+d(2,4,i)*pz4(i)
      cb37(i)=d(3,3,i)*ph4(i)+d(3,1,i)*py4(i)+d(3,4,i)*pz4(i)
      cb47(i)=d(4,3,i)*ph4(i)+d(4,1,i)*py4(i)+d(4,4,i)*pz4(i)
      cb18(i)=d(1,2,i)*pz4(i)+d(1,4,i)*py4(i)
      cb28(i)=d(2,2,i)*pz4(i)+d(2,4,i)*py4(i)
      cb38(i)=d(3,2,i)*pz4(i)+d(3,4,i)*py4(i)
