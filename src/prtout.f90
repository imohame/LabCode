...
!!      !--           u  , udt   ,udtt  ,dof   ,temp     ,x,y
      ...
      CALL EC_WriteConnectivity ( a(k02),a(k03),a(k04),a(k18), &
            a(k57),a(k08),a(k55),a(k56),a( k81 +1))

!!!!      EC_WriteConnectivity(ElemConnect,NodesCoordx, NodesCoordy,NodesDispl,DofIds
!!!!     ,ElemMaterial, udt,udtt,temp)
!!!!     - ElemConnect,NodesCoordx, NodesCoordy,NodesDispl,DofIds,ElemMaterial, udt   ,udtt  ,temp
...
!c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
      ...
      call outdv4 (a(k18),a(k55),a(k56),a(k57),numnp,a(k13),2*numnp)         
...
!c    1 2*numnp,a(k81+1))                                                     pl
      ...
      a(k08),a(k02),a(k10),a(k11),a(k81+1),tim(2),tim(3),tim(5), &
      a(k13),a(k13),a(k03),a(k04),a(lct),lpar(9))
