...
c     two crack tip for the element, update area_coeff, but 
c     do not add phantom nodes.		  
          
          call eleupdate11(ele, ix)
		  
	  else if((elecrack(2,ele)==3 .and. elecrack(4,ele)==1) .or.
     1        (elecrack(2,ele)==1 .and. elecrack(4,ele)==3)) then
