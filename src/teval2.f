      subroutine teval2(temp,npc,p,tbase,tmult,lcc,tt)
c     implicit double precision (a-h,o-z)                                    dp
c
c...  evaluate nodal temperatures from a load curve and vectors
c
      common/bk14/lfna(15),lfnt(6)
      common/cn1/numati,numnpi,numeli,nblk1,nslidi,ntslvi,ntmsri,
     1           nnpbi,nepbi,ncnpi
      dimension temp(*),npc(*),p(*),tbase(*),tmult(*)
c
      ierr=0
      xmag=1.0
      loc=npc(lcc)
