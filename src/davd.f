      subroutine davd(a,d,w,v,sp,neq,ntlen,nbfgs,numupd)
c     implicit double precision (a-h,o-z)                                    dp
      dimension a(*),d(*),w(*),v(*),alp(201)
      k13=igtpnt(13)
      k54=igtpnt(54)
   ...
   10 w(i)=sp*d(i)
      ...
      alfa0=alp(j)*dotprd(w,a(k13))
      do 20 i=1,neq
   20 d(i)=d(i)+alfa0*w(i)
   30 continue
      endif
      numupd=numupd+1
