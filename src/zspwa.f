...
C-----------------------------------------------------------------------ZSPR0290
C                                                                       ZSPR0300
      SUBROUTINE ZSPWA (FCN,N,X,FVEC,XTOL,MAXFEV,ML,MU,EPSFCN,DIAG,MODE,ZSPR0310
...
C                                  SPECIFICATIONS FOR LOCAL VARIABLES   ZSPR0390
     ...
     *                   XNORM,ZERO                                     ZSPR0440
      ...
      EXTERNAL           FCN                                            ZSPR0470
      DATA               SPMPAR /1.1921E-07/                            ZSPR0480
...
C                                  CALCULATE THE JACOBIAN MATRIX.       ZSPR0900
      IFLAG = 2                                                         ZSPR0910
      CALL ZSPWB(FCN,N,X,FVEC,FJAC,LDFJAC,IFLAG,ML,MU,EPSFCN,WA1,WA2,   ZSPR0920
     *PAR)                                                              ZSPR0930
...
C                                  CALCULATE ITS NORM.                  ZSPR1820
      IFLAG = 1                                                         ZSPR1830
      CALL FCN(WA2,WA4,N,PAR)                                           ZSPR1840
